...
const render = () => {
  mainCircle.lastX = circleMovement(mainCircle, 1, "x");
  mainCircle.lastY = circleMovement(mainCircle, 1, "y");
  ...
  followCircle.lastX = circleMovement(followCircle, 0.2, "x");
  followCircle.lastY = circleMovement(followCircle, 0.2, "y");
